...
[kTechDataTooltipInfo] =  "Try a fart or two. This mimicks marine commander Recyle to kill structure and give tres."},
        ...
        { [kTechDataId] = kTechId.PowerPointARMRUPG1,   
            [kTechDataDisplayName] = " default armr Tier 1 ARMR UPG",
 [kTechDataCostKey] = 10,   
 [kTechIDShowEnables] = false,     
  [kTechDataResearchTimeKey] = 60,
 [kTechDataHotkey] = Move.R, 
[kTechDataTooltipInfo] =  "+10% armr"},

        { [kTechDataId] = kTechId.PowerPointARMRUPG2,   
            [kTechDataDisplayName] = "Tier 2 ARMR UPG",
 [kTechDataCostKey] = 20,   
 [kTechIDShowEnables] = false,     
  [kTechDataResearchTimeKey] = 120,
 [kTechDataHotkey] = Move.R, 
[kTechDataTooltipInfo] =  "default hp +20% armr"},


        { [kTechDataId] = kTechId.PowerPointARMRUPG3,   
            [kTechDataDisplayName] = "Tier 3 ARMR UPG",
 [kTechDataCostKey] = 30,   
 [kTechIDShowEnables] = false,     
  [kTechDataResearchTimeKey] = 180,
 [kTechDataHotkey] = Move.R, 
[kTechDataTooltipInfo] =   "default hp +30% armr"},
