...
local kSoundData = 
{
    ...
    [kVoiceId.MarineRequestMedpack] =  {  Sound = "sound/NS2.fev/marine/voiceovers/medpack", Function = BuyMedPack, Description = "Purchase Medpack(2)", KeyBind = "RequestHealth"},
    [kVoiceId.MarineRequestAmmo] = {   Sound = "sound/NS2.fev/marine/voiceovers/ammo", Function = BuyAmmoPack, Description = "Purchase Ammopack(2)", KeyBind = "RequestAmmo"},
    ...
    [kVoiceId.AlienRequestMist] = { Function = BuyMist, Description = "Purchase Mist(10)", KeyBind = "RequestHealth", AlertTechId = kTechId.None },
