...
if not Player then return end
 ...
 if FirstCheckRulesHere(self, Client, Player, String, cost ) == false then return end
         ...
         if Player:GetTeamNumber() == 1 then
             ...
             elseif cost == 35 then DeductBuy(self, Client, cost, delayafter) Player:GiveDualRailgunExo(Player:GetOrigin())
             end
         elseif Player:GetTeamNumber() == 2 then
